...
import TemplateRenderer from "@/pages/template/TemplateRenderer";
import Academic from "@/pages/template/styles/professional/academic/Academic";
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/test" element={<Academic />} />
