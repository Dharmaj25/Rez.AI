...
const choiceIcons = {
    new_resume: PenLine,
    upload_resume: FileUp,
    existing_resume: Library,
};
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="min-w-0 flex-1">
                                    <p
                                        className={`text-[14px] font-medium ${isSelected ? "text-blue-700" : "text-slate-800"
                                            }`}
                                    >
                                        {opt.label}
                                    </p>
                                ...
                                <div
                                    className={`mt-1 flex size-5 shrink-0 items-center justify-center rounded-full border-2 transition-colors ${isSelected
                            ...
                            <AnimatePresence mode="wait">
                                {isSelected && opt.value === "upload_resume" && (
                                    <motion.div
                                        key="upload"
                                        layout
                                        ...
                                        className="mt-2 overflow-hidden rounded-xl border border-dashed border-slate-300 bg-slate-50/60"
                                    >
                                        <div className="p-5">
                                            {!fileName ? (
                            ...
                            <AnimatePresence mode="wait">
                                {isSelected && opt.value === "existing_resume" && (
                                    <motion.div
                                        key="library"
                                        layout
                                        initial={{ opacity: 0, height: 0, y: -15 }}
                                        ...
                                        exit={{ opacity: 0, height: 0, y: -15 }}
                                        transition={{ duration: 0.3 }}
                                        className="mt-2 overflow-hidden rounded-xl border border-slate-200 bg-slate-50/60"
                                    >
